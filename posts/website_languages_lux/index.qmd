...
(function() {{
  ...
  function updateChartsForMobile() {{
    ...
    // Figure 1: Line chart — adjust legend and margins
    ...
    // Figure 2: Stacked area chart — adjust legend and margins
    ...
    // Figure 3: Horizontal bar chart — adjust labels and margins
    ...
    Plotly.relayout(plots[2], isMobile ? {{
      ...
      'margin.l': 70, 'margin.r': 50,
      'margin.t': 10, 'xaxis.range': [0, 50],
      'xaxis.dtick': 10
    }} : {{
      'yaxis.ticktext': labels,
      'yaxis.tickvals': [...Array(labels.length).keys()],
      'margin.l': 200, 'margin.r': 80,
      'xaxis.range': [0, 48]
    }});
  }}

  setTimeout(updateChartsForMobile, 100);
