...
# Create abbreviated labels for mobile
abbrev_map = {
    'French': 'FR', 'German': 'DE', 'English': 'EN',
    'Luxembourgish': 'LB', 'Portuguese': 'PT', 'Dutch': 'NL'
}
...
fig.update_layout(
    height=500,
    margin=dict(t=20, r=60, b=50, l=200),
    plot_bgcolor="white",
    paper_bgcolor="white",
    xaxis=dict(title="% of websites", ticksuffix="%", range=[0, 45], gridcolor="#eee", zerolinecolor="#eee"),
