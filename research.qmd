...
::: {.paper-abstract}
We analyze whether a more liberal citizenship policy fosters the economic integration of first-generation immigrants. Our empirical setting is Germany, which, since unification, has abandoned its strict concept of citizenship based on ancestry ('jus sanguinis') in favor of a modern citizenship policy. Using a novel identification strategy, we exploit that the major citizenship reform in 1990 defined a sharp discontinuity in residency requirements. Based on a local randomization approach, we demonstrate that faster access to citizenship is a catalyst for integration, especially for immigrant women. Women's labor force participation increases by 8.9 percentage points and their earnings by 21.3%. We do not find any significant effects on immigrant men.
:::
:::
...
::: {.paper}
### It Starts at the Top: Managers and the Diffusion of AI {.paper-title}
